...
fetus = {
        ...
        "accelerations": None,
        "fetal_movement": None,
        "uterine_contractions": None,
        "light_decelerations": None,
        ...
        "histogram_min": None,
        "histogram_max": None,
        "histogram_number_of_peaks": None,
        "histogram_number_of_zeroes": None,
        "histogram_mode": None,
        "histogram_mean": None,
        "histogram_median": None,
        "histogram_variance": None,
        "histogram_tendency": None
}
...
#with cent_co:
#    st.image("img/image.png", caption="Sunrise by the mountains")
st.image("img/image.png")
...
if st.button("Predict Fetal Health"):
    ...
    match fetal_health:
        case 1:
            ...
            st.markdown(f"#### The baby is healthy, no action needed.")
            #t.write("")
        ...
        case 2:
            ...
            st.markdown(f"#### The baby is suspected of having a medical problem, further monitoring advised.")
            #st.write("")
